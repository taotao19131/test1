...
<%--************************************************--%>
        <div class="x_panel">
                <div class="x_title">
                    <h2 class="ttt">新增APP版本信息</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left" enctype="multipart/form-data"
                            method="post" action="/dev/app/version/addAppVersion">

                        <input type="hidden" value="${appInfoId}" name="appId"/>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">版本号<span class="required">*</span> </label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" class="form-control" name="versionNo" placeholder="请输入版本号">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" class="form-control" name="versionSize" placeholder="请输入版本大小,单位为Mb">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <textarea id="textarea" required="required" name="versionInfo" placeholder="请输入本版本的相关信息,本信息作为版本的详细信息进行版本的介绍" class="form-control col-md-7 col-xs-12"></textarea>
                            </div>
                        </div>

                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">APK文件<span class="required">*</span> </label>
                            <input id="f_upload" type="file" class="file" name="apk" />
                        </div>
...
<script>
    $("#datatable-buttons_next").click(function (){
        ...
        if (currentPageNo < totalPageNo) {
            ...
            window.location.assign("/dev/app/version/toAddAppVersion?currentPageNo="+currentPageNo);
        }
    ...
    $("#datatable-buttons_last").click(function () {
        ...
        if(lastPageNo > currentPageNo){
            ...
            window.location.assign("/dev/app/version/toAddAppVersion?currentPageNo="+lastPageNo);
        }
    });
