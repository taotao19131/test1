...
<div class="container body">
    <div class="main_container">
            ...
            <div class="left_col scroll-view">
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-home"></i> APP账户管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/login/toDevLogin">Dashboard</a></li>
                            ...
                            <li><a><i class="fa fa-edit"></i> APP应用管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/dev/app/appList" target="rightPage">APP维护</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="sidebar-footer hidden-small">
                    ...
                    <a data-toggle="tooltip"  data-placement="top" title="Logout">
                        <span class="glyphicon glyphicon-off" id="logout" aria-hidden="true"></span>
                    </a>
                </div>
                <!-- /menu footer buttons -->
            </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="images/img.jpg" alt="">${DEVUSER.devName}
        ...
        <div class="right_col" role="main">
            <iframe name="rightPage" src="/success" width="100%" height="850px"
...
<!-- gauge.js -->
<script src="/statics/js/gauge.min.js"></script>
<!-- bootstrap-progressbar -->
<script src="/statics/js/bootstrap-progressbar.min.js"></script>
<!-- bootstrap-daterangepicker -->
<script src="/statics/js/moment/moment.min.js"></script>
<script src="/statics/js/datepicker/daterangepicker.js"></script>
